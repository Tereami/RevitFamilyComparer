...
namespace RevitFamilyComparer
{
    ...
    {
        public List<FamilyCharacteristic> FamilyChars;
        ...
        public FamilyInfo(Document famDoc)
        {
            ...
            FamilyChars.Add(new FamilyCharacteristic("BasicFamilySettings", bfc));
            ...
            FamilyChars.Add(new FamilyCharacteristic("FamilyParameters", myFamParams));
        }
    }
}
